...
<head>
    ...
    <!-- Title -->
    <title>VISUCA - Directory &amp; Hotels</title>
...
<body>
    ...
    <!-- ***** Welcome Area Start ***** -->
    <section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/hotelwallpapaer5.jpg); height: 1050px;">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-10">
                    <div class="hero-content" style="margin-top: 150px;">
                        <h2>Discover Hotels near you</h2>
                    ...
                    <div class="hero-search-form">
                        <div class="tab-content" id="nav-tabContent" style="overflow-y: auto; scrollbar-width: none;" style="height: 200px;">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab" >
                                <h6>Which hotels are you looking for?</h6>
                                <div class="restaurant-grid-container">
                                    <div class="restaurant-grid">
                                        ...
                                        $query = $db->query("SELECT Nom, title, 'hotels-presentation-page.php?nom=' as PageLink FROM hotels");
