...
$query = "SELECT * FROM monuments WHERE nom = :nom";
...
<body style="background-image: url(<?php echo $restaurant['image6']; ?>);">
    <div class="container" >
        ...
        <div class="right-div">
            ...
            <div class="carousel">
                ...
                <?php echo('<img style="height: 400px;" src="' . $restaurant['image4'] . '"alt="Image du supermarché">')?>
