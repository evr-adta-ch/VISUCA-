...
<head>
    ...
    <!-- Title -->
    <title>VISUCA - Directory &amp; Stadiums</title>
...
<body>
                ...
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            ...
                            <div class="dorne-search-btn">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="searchDropdown">
                                      ...
                                      <a class="dropdown-item" href="yaounde-hotels.html">Hotels</a>
                                      <a class="dropdown-item" href="yaounde-restaurants.html">Restaurants</a>
                                      <a class="dropdown-item" href="yaounde-shop-center.html">Shop-center</a>
                                      <a class="dropdown-item" href="yaounde-beauty-center.html">Beauty-center</a>
                                      <a class="dropdown-item" href="yaounde-cinema.html">Movie teather</a>
                                      <a class="dropdown-item" href="stadium.html">Stadiums</a>
                                      <a class="dropdown-item" href="Museum.html">Museums</a>
                            ...
                            <!-- Signin btn -->
                            <div class="dorne-search-btn">
                                <a id="location-btn" href="localisation.html"><i class="fa fa-search" aria-hidden="true"></i>where am I now </a>
                            </div>
                            <!-- Add listings btn -->
                            <div class="dorne-search-btn">
    ...
    <!-- ***** Welcome Area Start ***** -->
    <section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/stade.jpeg); height: 1050px;">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-10">
                    <div class="hero-content" style="margin-top: 150px;">
                        <h2>Discover Sadiums near you</h2>
                    ...
                    <div class="hero-search-form">
                        <div class="tab-content" id="nav-tabContent" style="overflow-y: auto; scrollbar-width: none;" style="height: 200px;">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab" >
                                <h6>Which Stadium are you looking for?</h6>
                                <div class="restaurant-grid-container">
                                    <div class="restaurant-grid">
                                        ...
                                        $query = $db->query("SELECT Nom, title, 'stadium-presentation-page.php?nom=' as PageLink FROM stadium");
