...
<head>
    ...
    <!-- Title -->
    <title>VISUCA - Directory &amp; Movie Teather</title>
...
<body>
    ...
    <!-- ***** Welcome Area Start ***** -->
    <section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/cinema.jpg); height: 1050px;">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-10" style="margin-top: 150px;">
                    <div class="hero-content">
                        <h2>Discover Movie Theater near you</h2>
                    ...
                    <div class="hero-search-form">
                        <div class="tab-content" id="nav-tabContent" style="overflow-y: auto; scrollbar-width: none;" style="height: 200px;">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab" >
                                <h6>Which moivie Theater are you looking for?</h6>
                                <div class="restaurant-grid-container">
                                    <div class="restaurant-grid">
                                        ...
                                        $query = $db->query("SELECT Nom, title, 'cinema-presentation-page.php?nom=' as PageLink FROM cinema");
