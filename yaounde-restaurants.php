...
<head>
    ...
    <!-- Title -->
    <title>VISUCA - Directory &amp; Restaurants</title>
...
<body>
    ...
    <!-- ***** Welcome Area Start ***** -->
    <section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/resto.jpg); height: 1050px;">
                    ...
                    <div class="hero-search-form">
                        <div class="tab-content" id="nav-tabContent" style="overflow-y: auto; scrollbar-width: none;" style="height: 200px;">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab" >
                                <h6>Which restau are you looking for?</h6>
                                <div class="restaurant-grid-container">
                                    <div class="restaurant-grid">
                                        ...
                                        $query = $db->query("SELECT Nom, title, 'restaurants-presentation-page.php?nom=' as PageLink FROM restaurants");
